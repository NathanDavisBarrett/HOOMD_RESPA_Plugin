...
{
    pybind11::print("ADDED RESPAFORCECOMPUTE REFERENCE.");
    pybind11::class_<T, RespaForceCompute, std::shared_ptr<T> > respapotentialpair(m, name.c_str(), pybind11::base<ForceCompute>());
