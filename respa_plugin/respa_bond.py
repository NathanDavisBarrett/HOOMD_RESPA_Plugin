...
from hoomd.md import force, bond;
import hoomd;
...
class respa_harmonic(bond._bond):
    R""" Respa Harmonic bond potential.

    Args:
        name (str): Name of the bond instance.

    :py:class:`respa_harmonic` specifies a Respa harmonic potential energy between the two particles in each defined bond.
